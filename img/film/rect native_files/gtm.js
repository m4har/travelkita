...
"resource": {
  ...
  "tags":[{
      ...
      "vtp_gaSettings":["macro",4],
      "vtp_eventAction":"Click",
      "vtp_eventLabel":"Android Studio Click",
      "vtp_enableUaRlsa":false,
      "vtp_enableUseInternalVersion":false,
      "vtp_enableFirebaseCampaignData":true,
      "vtp_trackTypeIsEvent":true,
      ...
      "vtp_checkValidation":false,
      "vtp_waitForTagsTimeout":"2000",
      "vtp_uniqueTriggerId":"9642297_12",
      "tag_id":13
    },{
      "function":"__lcl",
      "vtp_waitForTags":false,
  ...
  "predicates":[{
      ...
      "function":"_cn",
      "arg0":["macro",0],
      "arg1":"devsite-dialog-button button dac-button dac-outline-button"
    },{
      "function":"_cn",
      "arg0":["macro",1],
  ...
  "rules":[
    ...
    [["if",14,15,16],["add",6]],
    [["if",2,17,18,19],["add",7]],
    [["if",20],["add",8,9,10,11,12,13,14,15]]]
},
"runtime":[
[],[]
]
...
var Pg=function(a,b,c){function d(){var b=a();g+=e?(Ca().getTime()-e)*b.playbackRate/1E3:0;e=Ca().getTime()}var e=0,g=0;return{Ra:function(e,k,l){var h=a(),n=h.ac,p=void 0!==l?Math.round(l):void 0!==k?Math.round(h.ac*k):Math.round(h.ud),q=void 0!==k?Math.round(100*k):0>=n?0:Math.round(p/n*100),r=B.hidden?!1:.5<=Hg(c);d();var u=df(c);u.event="gtm.video";u["gtm.videoProvider"]="youtube";u["gtm.videoStatus"]=e;u["gtm.videoUrl"]=h.url;u["gtm.videoTitle"]=h.title;u["gtm.videoDuration"]=Math.round(n);u["gtm.videoCurrentTime"]=
Math.round(p);u["gtm.videoElapsedTime"]=Math.round(g);u["gtm.videoPercent"]=q;u["gtm.videoVisible"]=r;u["gtm.triggers"]=b;z["dataLayer"].push(u)},Fe:function(){e=Ca().getTime()},cb:function(){d()}}};var Qg="www.googletagmanager.com/gtm.js";
...
var fh=function(a){var b=0;b=Hg(a);return b},gh=function(a){},hh=function(a){var b=!1;b=Ig(a);return b},ih=function(a,b){var c;a:{if(a&&
ua(a))for(var d=0;d<a.length;d++)if(a[d]&&b(a[d])){c=a[d];break a}c=void 0}return c},jh=function(a,b,c,d){ff(a,b,c,d)},kh=function(a,b,c){return gf(a,b,c)},lh=function(a){return!!gf(a,"init",!1)},mh=function(a){ef(a).init=!0};var nh=function(a,b,c){return Pg(a,b,c)};
...
Z.a.ytl=["google"],function(){function a(){var b=Math.round(1E9*Math.random())+"";return lb(b)?a():b}function b(a,b){if(!a)return!1;for(var c=0;c<p.length;c++)if(0<=a.indexOf("//"+p[c]+"/"+b))return!0;return!1}function c(a){var b=-1!==a.indexOf("?")?"&":"?";if(-1<a.indexOf("origin="))return a+b+"enablejsapi=1";if(!r){var c=V("document");r=c.location.protocol+"//"+c.location.hostname;c.location.port&&(r+=":"+c.location.port)}return a+b+"enablejsapi=1&origin="+encodeURIComponent(r)}function d(a,d){var e=
a.getAttribute("src");if(b(e,"embed/")){if(0<e.indexOf("enablejsapi=1"))return!0;if(d)return a.setAttribute("src",c(e)),!0}return!1}function e(b,c){if(!b.getAttribute("data-gtm-yt-inspected-"+c.Eb)&&(b.setAttribute("data-gtm-yt-inspected-"+c.Eb,"true"),d(b,c.fc))){b.id||(b.id=a());var e=V("YT"),g=e.get(b.id);g||(g=new e.Player(b.id));var k=h(g,c),l={},m;for(m in k)l.key=m,k.hasOwnProperty(l.key)&&g.addEventListener(l.key,function(a){return function(b){return k[a.key](b.data)}}(l)),l={key:l.key}}}
function g(a){H(function(){function b(){for(var b=c.getElementsByTagName("iframe"),d=b.length,g=0;g<d;g++)e(b[g],a)}var c=V("document");b();Fg(b)})}function h(a,b){var c,d;function e(){r=nh(function(){return{url:O,title:Y,ac:S,ud:a.getCurrentTime(),playbackRate:ba}},b.Eb,a.getIframe());S=0;Y=O="";ba=1;return g}function g(c){switch(c){case q.PLAYING:S=Math.round(a.getDuration());O=a.getVideoUrl();if(a.getVideoData){var d=a.getVideoData();Y=d?d.title:""}ba=a.getPlaybackRate();b.od?r.Ra("start"):r.cb();
A=m(b.ve,b.ue,a.getDuration());return h(c);default:return g}}function h(){ca=a.getCurrentTime();wa=(new Date).getTime();r.Fe();u();return k}function k(c){var d;switch(c){case q.ENDED:return n(c);case q.PAUSED:d="pause";case q.BUFFERING:var g=a.getCurrentTime()-ca;d=1<Math.abs(((new Date).getTime()-wa)/1E3*ba-g)?"seek":d||"buffering";a.getCurrentTime()&&(b.nd?r.Ra(d):r.cb());t();return l;case q.UNSTARTED:return e(c);default:return k}}function l(a){switch(a){case q.ENDED:return n(a);case q.PLAYING:return h(a);
case q.UNSTARTED:return e(a);default:return l}}function n(){for(;d;){var a=c;z.clearTimeout(d);a()}b.md&&r.Ra("complete",1);return e(q.UNSTARTED)}function p(){}function t(){d&&(z.clearTimeout(d),d=0,c=p)}function u(){if(A.length&&0!==ba){var b=-1,e;do{e=A[0];if(e.aa>a.getDuration())return;b=(e.aa-a.getCurrentTime())/ba;if(0>b&&(A.shift(),0===A.length))return}while(0>b);c=function(){d=0;c=p;0<A.length&&A[0].aa===e.aa&&(A.shift(),r.Ra("progress",e.Cc,e.Gc));u()};d=Tg(c,1E3*b)}}var r,A=[],S,O,Y,ba,ca,
wa,za=e(q.UNSTARTED);d=0;c=p;return{onStateChange:function(a){za=za(a)},onPlaybackRateChange:function(b){ca=a.getCurrentTime();wa=(new Date).getTime();r.cb();ba=b;t();u()}}}function k(a){for(var b=a.split(","),c=b.length,d=[],e=0;e<c;e++){var g=parseInt(b[e],10);isNaN(g)||100<g||0>g||d.push(g/100)}d.sort(function(a,b){return a-b});return d}function l(a){for(var b=a.split(","),c=b.length,d=[],e=0;e<c;e++){var g=parseInt(b[e],10);isNaN(g)||0>g||d.push(g)}d.sort(function(a,b){return a-b});return d}function m(a,
b,c){var d=a.map(function(a){return{aa:a,Gc:a,Cc:void 0}});if(!b.length)return d;var e=b.map(function(a){return{aa:a*c,Gc:void 0,Cc:a}});if(!d.length)return e;var g=d.concat(e);g.sort(function(a,b){return a.aa-b.aa});return g}function n(a){var c=!!a.vtp_captureStart,e=!!a.vtp_captureComplete,h=!!a.vtp_capturePause,m=k(a.vtp_progressThresholdsPercent+""),n=l(a.vtp_progressThresholdsTimeInSeconds+""),p=!!a.vtp_fixMissingApi;if(c||e||h||m.length||n.length){var q={od:c,md:e,nd:h,ue:m,ve:n,fc:p,Eb:void 0===
a.vtp_uniqueTriggerId?"":a.vtp_uniqueTriggerId},t=V("YT"),r=function(){g(q)};H(a.vtp_gtmOnSuccess);if(t)t.ready&&t.ready(r);else{var R=V("onYouTubeIframeAPIReady");Yg("onYouTubeIframeAPIReady",function(){R&&R();r()});H(function(){for(var a=V("document"),c=a.getElementsByTagName("script"),e=c.length,g=0;g<e;g++){var h=c[g].getAttribute("src");if(b(h,"iframe_api")||b(h,"player_api"))return}for(var k=a.getElementsByTagName("iframe"),l=k.length,m=0;m<l;m++)if(!u&&d(k[m],q.fc)){T("https://www.youtube.com/iframe_api");
u=!0;break}})}}else H(a.vtp_gtmOnSuccess)}var p=["www.youtube.com","www.youtube-nocookie.com"],q={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5},r,u=!1;Z.__ytl=n;Z.__ytl.g="ytl";Z.__ytl.h=!0;Z.__ytl.b=0}();
